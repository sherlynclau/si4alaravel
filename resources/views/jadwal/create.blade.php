                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <select class ="form-control" name="matakuliah_id">
                            ...
                            <option value="{{ $item->id }}" {{ old('matakuliah_id')}}> {{ $item->nama }} </option>
                            @endforeach
                        </select>
                        @error('matakuliah_id')
                            <div class="text-danger">{{ $message }}</div>
                      ...
                      <div class="mb-3">
                        ...
                        <select class ="form-control" name="dosen_id">
                            ...
                            <option value="{{ $item->id }}" {{ old('dosen_id')}}> {{ $item->name }} </option>
                            @endforeach
                        </select>
                        @error('dosen_id')
                          <div class="text-danger">{{ $message }}</div>
                      ...
                      <div class="mb-3">
                          ...
                          <select class ="form-control" name="sesi_id">
                              ...
                              <option value="{{ $item->id }}" {{ old('sesi_id')}}> {{ $item->nama }} </option>
